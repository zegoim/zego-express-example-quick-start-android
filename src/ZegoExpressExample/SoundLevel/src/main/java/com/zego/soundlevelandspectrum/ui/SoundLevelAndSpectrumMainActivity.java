package com.zego.soundlevelandspectrum.ui;
...
import com.zego.soundlevelandspectrum.R;
import com.zego.soundlevelandspectrum.widget.SoundLevelAndSpectrumItem;
import com.zego.soundlevelandspectrum.widget.SpectrumView;
...
public class SoundLevelAndSpectrumMainActivity extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        // 创建引擎
        mSDKEngine = ZegoExpressEngine.createEngine(GetAppIDConfig.appID, GetAppIDConfig.appSign, true, ZegoScenario.SCENARIO_GENERAL, this.getApplication(), null);
        // 增加本专题所用的回调
